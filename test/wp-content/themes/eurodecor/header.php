...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="<?php bloginfo('template_url'); ?>/js/jquery.tinycarousel.js" language="javascript" type="text/javascript"></script>
	...
	<body>
		<div class="container">
			...
			<ul id="menu">
				...
				<li class="ani">
					<a href="<?php bloginfo('url'); ?>/shops">магазины</a>
				</li>
				<li class="ani">
