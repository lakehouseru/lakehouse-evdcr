<?php
	...
	$theme['author'] = "Gilbert Pellegrom (Adapted to WP Carousel by Sumolari)";
	$theme['author_url']= "http://nivo.dev7studios.com";
	$theme['name'] = __('Nivo Slider - Default', 'wp_carousel');
	$theme['url'] = "http://sumolari.com/wp-carousel";
	$theme['desc'] = __('Use Nivo Slider with the Default theme', 'wp_carousel');
	$theme['version'] = '1.0';
