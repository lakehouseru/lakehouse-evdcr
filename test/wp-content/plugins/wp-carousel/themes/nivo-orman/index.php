<?php
	...
	$theme['author'] = "Gilbert Pellegrom & Orman Clark (Adapted to WP Carousel by Sumolari)";
	$theme['author_url']= "http://nivo.dev7studios.com";
	$theme['name'] = __('Nivo Slider - Orman', 'wp_carousel');
	$theme['url'] = "http://sumolari.com/wp-carousel";
	$theme['desc'] = __('Use Nivo Slider with the Orman theme', 'wp_carousel');
	$theme['version'] = '1.0';
	...
	*/
	...
	$theme['custom_settings'] = array(
		...
		'show_badge' => array(
			'type' => 'select',
			'default_value' => '0',
			'title' => 'Display "What\'s hot!" badge',
			'values' => array(
				1 => 'Display badge',
